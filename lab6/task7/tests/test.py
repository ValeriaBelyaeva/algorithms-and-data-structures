# lab6/task7/tests/test.py

import unittest
import os

from lab6.task7.src.precious_stones import task7, PATH, OUTPUT_PATH

class TestPreciousStones(unittest.TestCase):

    def setUp(self):
        self.test_input_path = r"D:\algorithms-and-data-structures\lab6\task7\txtf\test_input.txt"
        self.test_output_path = r"D:\algorithms-and-data-structures\lab6\task7\txtf\test_output.txt"
    ...
    def _override_global_paths(self):
        import lab6.task7.src.precious_stones as module
    ...
    def test_example1(self):
        ...
        # пара (a,a), считаем кол-во пар (i<j) S[i]=='a' and S[j]=='a'
    ...
    def test_example2(self):
        ...
        # S= a b a c a b a
        # pairs: (a,b), (a,c), (b,b)
        # 1) (a,b): i<j, S[i] ='a', S[j] ='b'
        #     a on [0,2,4,6], b on [1,5]
        #     кол-во (a,b) пар: (0,1), (2,5), (4,5), итого 3 + (0,5)? wait i<j => (0,1),(0,5),(2,5),(4,5), (6,??) no j>6? => 4
        # 2) (a,c): a in [0,2,4,6], c in [3], пары: (0,3),(2,3),(4,3),(6,3)? j=3 < i=6? no i<j => i=6>3, skip => (0,3),(2,3),(4,3) => 3
